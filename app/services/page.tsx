...
const allServices = [
  {
    ...
    badge: "24/7",
    desc: "Fast dispatch for breakdowns, collisions, and stalled vehicles. Flatbed and wheel-lift trucks available for all vehicle types including EVs.",
    bullets: ["Under 15 min response", "Flatbed & wheel-lift trucks", "All vehicle types including EVs", "Tow to any destination"],
  },
  {
    id: "flat-tire",
  ...
  },
  {
    ...
    alt: "Accident recovery towing Surrey — damaged vehicle being loaded on flatbed",
  ...
  },
  {
    ...
    badge: "Secure",
    desc: "Secure, on-time vehicle transport across Surrey and the Lower Mainland. Running and non-running vehicles, flatbed and wheel-lift available.",
    bullets: ["Flatbed & wheel-lift trucks", "Running & non-running vehicles", "On-time pickup & delivery", "Licensed & insured"],
  },
  {
    id: "fuel-delivery",
