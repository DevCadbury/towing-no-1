            ...
            <div className="lg:col-span-2 space-y-8">
              <div>
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  Running out of fuel is a frustrating situation — especially on a busy highway or late at night. TowingNo.1 delivers enough gasoline or diesel to get you to the nearest station, dispatching in <strong>under 15 minutes</strong> across Surrey and the Lower Mainland.
                </p>
                <p className="text-slate-600 leading-relaxed mb-4">
